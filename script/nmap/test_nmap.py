...
def test_command_line():
    ...
    assert_equals(nm.command_line(),
                  './nmap-{0}/nmap -sV -oX scanme_output-{0}.xml scanme.nmap.org'.format(NMAP_XML_VERSION))
...
def test_csv_output():
    ...
    if NMAP_XML_VERSION == '6.40':
        ...
        assert_equals(
            '45.33.32.156;scanme.nmap.org;user;tcp;22;ssh;open;OpenSSH;"Ubuntu Linux; protocol 2.0";syn-ack;6.6.1p1 Ubuntu 2ubuntu2.3;10;cpe:/o:linux:linux_kernel',
            nm.csv().split('\n')[1].strip())
