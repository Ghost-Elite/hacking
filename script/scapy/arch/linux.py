...
class L2Socket(SuperSocket):
    ...
    def __init__(self,
        ...
        if sa_ll[3] in conf.l2types:
            ...
            self.lvl = 2
            warning("Unable to guess type (interface=%s protocol=%#x family=%i). Using %s", sa_ll[0], sa_ll[1],
                    sa_ll[3], self.LL.name)  # noqa: E501
...
class VEthPair(object):
    ...
    def setup(self):
        ...
        subprocess.check_call(
            ['ip', 'link', 'add', self.ifaces[0], 'type', 'veth', 'peer', 'name', self.ifaces[1]])  # noqa: E501
